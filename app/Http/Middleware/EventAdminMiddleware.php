...
class EventAdminMiddleware
{
    ...
    public function handle(Request $request, Closure $next): Response
    {
        ...
        $managedEventIds = $user->getManagedEventIds();

        // Admin event must have at least one assigned event
